        ...
        scope.launch {
            while (true) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    if (tv != null) {
                        tv.text = text
                        // Android ရဲ့ built-in marquee က setText() တိုင်း ပျက်သွားတတ်ပါတယ်
                        // (တဝက်ကနေ ရပ်နေသလို ဖြစ်တာ ဒါကြောင့်ပါ) - ဒါကို isSelected ကို
                        // ပိတ်/ဖွင့် ပြန်လုပ်ပြီး အစကနေ ချောချော ပြန်စေအောင် force လုပ်ပါတယ်
                        tv.isSelected = false
                        tv.post { tv.isSelected = true }
                    }
                }
